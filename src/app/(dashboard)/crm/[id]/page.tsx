        ...
        {customer === undefined ? (
          ...
          <div className="rounded-2xl border border-red-400/20 bg-red-400/[0.06] p-8">
            ...
            <p className="mt-2 text-sm text-[#9CA3AF]">
              El registro ya no existe o no está disponible en este dispositivo.
            </p>
            <Link
              href="/crm"
              className="mt-5 inline-flex items-center gap-2 text-xs font-semibold text-[#7187ff] transition hover:text-white"
            >
              <ArrowLeft size={14} />
              Volver a clientes
            </Link>
          ...
          <>
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      ...
                      <p className="text-sm text-[#9CA3AF]">
                        {customer.contact} · {customer.projectType}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="space-y-5">
                  ...
                  <div className="space-y-5 p-5 sm:p-6">
                    ...
                    <div className="grid grid-cols-2 gap-5 border-t border-white/[0.06] pt-5">
                      <div>
                        ...
                        <p className="mt-2 text-xs font-semibold text-[#91a2ff]">
                          {customer.folio ?? 'Sin folio'}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-xs text-[#d5d7df]">
                ...
                <Card>
                  <CardHeader
                    ...
                    description="Responsable y estado de la relación"
                  />
                  <div className="grid grid-cols-2 gap-5 p-5 sm:p-6">
                    <div>
                      ...
                      <p className="mt-2 text-xs font-medium text-white">
                        {customer.assignedSalesperson || 'Sin asignar'}
                      </p>
                    </div>
              ...
              <Card>
                <CardHeader
                  title="Historial de relación"
                  description="Conversaciones y actividad reciente"
                />
                <div className="p-5 sm:p-6">
                  {customer.timeline.length ? (
                    <CustomerTimeline events={customer.timeline} />
                  ) : (
                    <p className="py-8 text-center text-sm text-[#646873]">
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        <p className="mt-1 text-xs leading-5 text-[#d5d7df]">
          {value || 'Sin registrar'}
        </p>
      </div>
    </div>
